...
| `vault` | **Bilgi kasası** (Obsidian'sız): ucuz indeks + gerektiğinde açılan notlar; `index`/`stats`/`add` |
...
| `compose` | MiMo workflow (`start/list/resume [session]/runs` — kesinti sonrası devam) |
